...
from microfinance.config import username, apikey
from django.http import HttpResponse
from django.views.decorators.csrf import csrf_exempt
import datetime
from microfinance.models import session_levels
from microfinance.models import Microfinance
from microfinance.models import account
from microfinance.models import checkout
...
def callback(request):
    ...
    if request.method == "POST" and request.POST:
        ...
        try:
            ...
            result, created = Microfinance.objects.get_or_create(
            ...
            if result and result.name and result.city:
                ...
                if level == 0 or level == 1:
                    ...
                    if userResponse == "":
                        if level == 0:
                            ...
                            session_level1 = Microfinance.objects.get(
                                phonenumber=phoneNumber
                            )
                            ...
                            response = (
                                "CON Welcome to Nerd Microfinance, "
                                + result.name
                                + " Choose a service.\n"
                            )
                    ...
                    if userResponse == "0":
                        if level == 0:
                            # 7b.Graduate user to next level and serve main menu
                            session1 = session_levels(
                                session_id=sessionId, phoneNumber=phoneNumber, level=1
                            )
                            session1.save()
                    ...
                    if userResponse == "2":
                        if level == 1:
                            ...
                            session_level9 = Microfinance.objects.get(
                                phonenumber=phoneNumber
                            )
                    ...
                    if userResponse == "3":
                        if level == 1:
                            ...
                            session_level10 = Microfinance.objects.get(
                                phonenumber=phoneNumber
                            )
                    ...
                    if userResponse == "4":
                        if level == 1:
                            ...
                            session_level11 = Microfinance.objects.get(
                                phonenumber=phoneNumber
                            )
                    ...
                    if userResponse == "5":
                        ...
                        if sql10a:
                            ...
                            if newBal > 0:
                                ...
                                recipients = [
                                    {"phoneNumber": phoneNumber, "amount": "KES 5"}
                                ]
                    ...
                    if userResponse == "6":
                        if level == 1:
                            ...
                            session_level11 = session_levels.objects.get(
                ...
                if level == 9:
                    ...
                    if userResponse == "1":
                        ...
                        sqlz = checkout(
                            status="pending", amount=amount, phonenumber=phoneNumber
                        )
                        sqlz.save()
                ...
                if level == 11:
                    ...
                    if Bal > 0:
                        ...
                        sql11d = account(
                            phonenumber=userResponse, balance=Bal, loan=Loan
                        )
                        sql11d.save()
                        ...
                        message = (
                            ...
                            + " "
                            + userResponse
                            + " If this is a wrong number the transaction will fail.Your  balance is "
                            + str(Bal)
                            + " Thank you."
                        )
                        ...
                        recipients = [
                            {
                                ...
                                "currencyCode": "KES",
                                "amount": 1,
                                "metadata": {"name": "Client", "reason": "Withdrawal"},
                            }
                        ]
                        # Send B2c
                        try:
